...
public class TitleBarRightPanel extends JPanel {
    ...
    public TitleBarRightPanel(JFrame jFrame) {
        ...
        // 最小化按钮
        TitleButton min = new TitleButton("<html><span color=#c6e2ff>—</span></html>");
        ...
        //最大化
        TitleButton max = new TitleButton("<html><span color=#c6e2ff>□</span></html>");
        ...
        //关闭
        TitleButton close = new TitleButton("<html><span color=#c6e2ff>×</span></html>");
